...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(Client::class, ['created_by_whom' => 'id']);
    }
    ...
    {
        return $this->hasMany(Client::class, ['deleted_by_whom' => 'id']);
    }
    ...
    {
        return $this->hasMany(Client::class, ['updated_by_whom' => 'id']);
    }
    ...
    {
        return $this->hasMany(Club::class, ['created_by_whom' => 'id']);
    }
    ...
    {
        return $this->hasMany(Club::class, ['deleted_by_whom' => 'id']);
    }
    ...
    {
        return $this->hasMany(Club::class, ['updated_by_whom' => 'id']);
    }
}
